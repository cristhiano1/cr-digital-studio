...
function RotatingGlobe() {
  return (
    <div
      ...
      style={{ bottom: '-18%', right: '-8%', width: '520px', height: '520px', opacity: 0.09 }}
      aria-hidden="true"
    >
      <svg
        viewBox="0 0 200 200"
      ...
      >
        <circle cx="100" cy="100" r="90" stroke="#64CEFB" strokeWidth="0.5" />
        <circle cx="100" cy="100" r="70" stroke="#64CEFB" strokeWidth="0.4" />
        <circle cx="100" cy="100" r="48" stroke="#64CEFB" strokeWidth="0.3" />
        <ellipse cx="100" cy="100" rx="90" ry="38" stroke="#0A8CFF" strokeWidth="0.5" />
        <ellipse cx="100" cy="100" rx="90" ry="38" stroke="#0A8CFF" strokeWidth="0.4" transform="rotate(60 100 100)" />
        <ellipse cx="100" cy="100" rx="90" ry="38" stroke="#0A8CFF" strokeWidth="0.4" transform="rotate(120 100 100)" />
        <line x1="100" y1="10" x2="100" y2="190" stroke="#64CEFB" strokeWidth="0.3" />
        <line x1="10" y1="100" x2="190" y2="100" stroke="#64CEFB" strokeWidth="0.3" />
      </svg>
    </div>
  )
}
